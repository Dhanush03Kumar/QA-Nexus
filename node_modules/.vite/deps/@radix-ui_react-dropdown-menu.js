...
var DismissableLayer = React12.forwardRef(
  (props, forwardedRef) => {
    ...
    const isDeferredPointerDownOutsideRef = React12.useRef(false);
...
function usePointerDownOutside(onPointerDownOutside, args) {
  ...
  const isPointerDownOutsideRef = React12.useRef(false);
  const interceptedOutsideInteractionEventsRef = React12.useRef(/* @__PURE__ */ new Map());
...
var Popper = (props) => {
  ...
  const [placementState, setPlacementState] = React19.useState(void 0);
...
var PopperAnchor = React19.forwardRef(
  (props, forwardedRef) => {
    ...
    const callbackRef = React19.useCallback(
      (node) => {
        ref.current = node;
        if (node) {
          onAnchorChange(node);
